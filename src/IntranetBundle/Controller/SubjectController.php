...
use IntranetBundle\Entity\Subject;
...
class SubjectController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $subjects = $em->getRepository('IntranetBundle:Subject')->findAll();
    ...
    {
        $subject = new Subject();
        $form = $this->createForm('IntranetBundle\Form\SubjectType', $subject);
    ...
    {
        $deleteForm = $this->createDeleteForm($subject);
        $editForm = $this->createForm('IntranetBundle\Form\SubjectType', $subject);
